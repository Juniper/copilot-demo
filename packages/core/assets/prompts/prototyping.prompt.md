---
mode: agent
description: This reusable prompt is used to guide the prototyping process for a project.
---
...
# This reusable prompt is used to guide the prototyping process for a project. The input context is received from the user as a project description, and the output is a prototyping plan that includes the project scope, requirements, architecture, technology stack, and timeline.

- For detailed prototyping instructions, refer to the [prototyping instructions](../instructions/prototyping.instructions.md).
...
- Gather any additional information or clarifications needed to create a prototyping plan.
